...
// Type: Kingdoms.CapitalSendTroopsPanel2
...
namespace Kingdoms
{
  public class CapitalSendTroopsPanel2 : CustomSelfDrawPanel, IDockableControl
  {
    ...
    public void init(bool resized)
    {
      ...
      this.catapultStoredValue.Position = new Point(56, y + 160);
      ...
      this.catapultSendValue.Position = new Point(56, y + 160);
      ...
      this.barrackSpaceLabel.Size = new Size(this.Width, 40);
      ...
      this.backgroundImage.addControl((CustomSelfDrawPanel.CSDControl) this.barrackSpaceLabel);
      ...
      this.warningLabel.Size = new Size(this.Width, 40);
      ...
      this.backgroundImage.addControl((CustomSelfDrawPanel.CSDControl) this.warningLabel);
    ...
    public void updateSlider()
    {
      ...
      if (village == null)
        return;
      if (this.peasantsTrack.Value + this.archerTrack.Value + this.pikemanTrack.Value + this.swordsmanTrack.Value + this.catapultTrack.Value > 0 && village.VillageID != this.m_selectedVillage)
    ...
    private void editSendValue()
    {
      ...
      Point screen = InterfaceMgr.Instance.ParentForm.PointToScreen(new Point(this.Location.X + 680, this.Location.Y + num));
    ...
    private void InitializeComponent()
    {
      ...
      this.Name = nameof (CapitalSendTroopsPanel2);
