...
// Type: Kingdoms.NewSelectVillageAreaWindow
...
namespace Kingdoms
{
  public class NewSelectVillageAreaWindow : Form
  {
    ...
    private void InitializeComponent()
    {
      ...
      this.customPanel.Size = new Size(1082, 682);
      this.customPanel.StoredGraphics = (Graphics) null;
      this.customPanel.TabIndex = 0;
      this.AutoScaleMode = AutoScaleMode.None;
      this.BackColor = ARGBColors.Fuchsia;
      this.ClientSize = new Size(1082, 682);
      this.ControlBox = false;
      this.Controls.Add((Control) this.customPanel);
      this.FormBorderStyle = FormBorderStyle.None;
      this.MinimumSize = new Size(10, 10);
      this.Name = nameof (NewSelectVillageAreaWindow);
      this.ShowIcon = false;
      this.ShowInTaskbar = false;
      this.StartPosition = FormStartPosition.Manual;
      this.Text = nameof (NewSelectVillageAreaWindow);
      this.TransparencyKey = ARGBColors.Fuchsia;
      this.FormClosing += new FormClosingEventHandler(this.NewSelectVillageAreaWindow_FormClosing);
