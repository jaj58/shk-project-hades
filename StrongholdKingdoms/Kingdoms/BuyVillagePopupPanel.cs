...
// Type: Kingdoms.BuyVillagePopupPanel
...
namespace Kingdoms
{
  public class BuyVillagePopupPanel : CustomSelfDrawPanel
  {
    ...
    public void init(int villageID, bool buy)
    {
      ...
      this.backgroundRightEdge.Position = new Point(this.Width - 2, 0);
      ...
      this.titleImage.addControl((CustomSelfDrawPanel.CSDControl) this.headingLabel);
      this.inset.Position = new Point(11, 104);
      this.inset.Size = new Size(646, 368);
      this.mainBackgroundImage.addControl((CustomSelfDrawPanel.CSDControl) this.inset);
      ...
      this.scrollArea.addControl((CustomSelfDrawPanel.CSDControl) this.bigButton1);
      this.featuresImage1.Image = (Image) GFXLibrary.villageType_types[1];
      this.featuresImage1.Position = new Point(292, y + num1);
      this.featuresImage1.Visible = true;
      this.scrollArea.addControl((CustomSelfDrawPanel.CSDControl) this.featuresImage1);
      this.description1.Text = SK.Text("MapTypesDescription_Lowland", "A balanced location with good space and no drawbacks.");
      this.description1.Position = new Point(5, 41 + num2);
      ...
      this.description1.Color = Color.FromArgb((int) byte.MaxValue, 254, 220);
      this.featuresImage1.addControl((CustomSelfDrawPanel.CSDControl) this.description1);
      this.featuresOverImage1.Image = (Image) GFXLibrary.villageType_types[0];
      this.featuresOverImage1.Position = new Point(292, y + num1);
      this.featuresOverImage1.Visible = false;
      this.scrollArea.addControl((CustomSelfDrawPanel.CSDControl) this.featuresOverImage1);
      this.featuresLabela1.Text = SK.Text("NewVillage_Space", "Space") + ":";
      this.featuresLabela1.Position = new Point(5, 7 + num2);
      ...
      this.featuresLabela1.Color = Color.FromArgb((int) byte.MaxValue, 254, 220);
      this.featuresOverImage1.addControl((CustomSelfDrawPanel.CSDControl) this.featuresLabela1);
      Size textSize1 = this.featuresLabela1.TextSize;
      this.featuresLabeld1.Text = SK.Text("NewVillage_Medium", "Medium");
      this.featuresLabeld1.Position = new Point(5 + textSize1.Width + 5, 7 + num2);
      this.featuresLabeld1.Size = new Size(this.featuresImage1.Width - 10 - textSize1.Width - 5, this.featuresImage1.Height - 20);
      this.featuresLabeld1.Font = FontManager.GetFont("Arial", 9f, FontStyle.Regular);
      this.featuresLabeld1.Color = Color.FromArgb((int) byte.MaxValue, 254, 220);
      this.featuresOverImage1.addControl((CustomSelfDrawPanel.CSDControl) this.featuresLabeld1);
      this.featuresLabelb1.Text = SK.Text("NewVillage_Castle", "Castle natural defenses") + ":";
      this.featuresLabelb1.Position = new Point(5, 31 + num2);
      ...
      this.featuresLabelb1.Color = Color.FromArgb((int) byte.MaxValue, 254, 220);
      this.featuresOverImage1.addControl((CustomSelfDrawPanel.CSDControl) this.featuresLabelb1);
      Size textSize2 = this.featuresLabelb1.TextSize;
      this.featuresLabele1.Text = SK.Text("NewVillage_None", "None");
      this.featuresLabele1.Position = new Point(5 + textSize2.Width + 5, 31 + num2);
      this.featuresLabele1.Size = new Size(this.featuresImage1.Width - 10 - textSize2.Width - 5, this.featuresImage1.Height - 20);
      this.featuresLabele1.Font = FontManager.GetFont("Arial", 9f, FontStyle.Regular);
      this.featuresLabele1.Color = Color.FromArgb((int) byte.MaxValue, 254, 220);
      this.featuresOverImage1.addControl((CustomSelfDrawPanel.CSDControl) this.featuresLabele1);
      this.featuresLabelc1.Text = SK.Text("NewVillage_Production", "Production bonus to") + ":";
      this.featuresLabelc1.Position = new Point(5, 55 + num2);
      ...
      this.featuresLabelc1.Color = Color.FromArgb((int) byte.MaxValue, 254, 220);
      this.featuresOverImage1.addControl((CustomSelfDrawPanel.CSDControl) this.featuresLabelc1);
      textSize2 = this.featuresLabelc1.TextSize;
      this.featuresLabelf1.Text = SK.Text("NewVillage_None", "None");
      this.featuresLabelf1.Position = new Point(5 + textSize2.Width + 5, 55 + num2);
      this.featuresLabelf1.Size = new Size(this.featuresImage1.Width - 10 - textSize2.Width - 5, this.featuresImage1.Height - 20);
      this.featuresLabelf1.Font = FontManager.GetFont("Arial", 9f, FontStyle.Regular);
      this.featuresLabelf1.Color = Color.FromArgb((int) byte.MaxValue, 254, 220);
      this.featuresOverImage1.addControl((CustomSelfDrawPanel.CSDControl) this.featuresLabelf1);
      ...
      this.helpButton1.Position = new Point(this.featuresImage1.Position.X + 278, this.featuresImage1.Position.Y + num2 - 8);
      ...
      this.scrollArea.addControl((CustomSelfDrawPanel.CSDControl) this.helpButton1);
      ...
      this.scrollArea.addControl((CustomSelfDrawPanel.CSDControl) this.bigButton2);
      this.featuresImage2.Image = (Image) GFXLibrary.villageType_types[2];
      this.featuresImage2.Position = new Point(292, y + num1 + 630);
      this.featuresImage2.Visible = true;
      this.scrollArea.addControl((CustomSelfDrawPanel.CSDControl) this.featuresImage2);
      ...
      if (Program.mySettings.LanguageIdent == "de" || Program.mySettings.LanguageIdent == "tr")
        this.description2.Position = new Point(5, 36 + num2);
      else
        this.description2.Position = new Point(5, 41 + num2);
      this.description2.Size = new Size(this.featuresImage2.Width - 10, this.featuresImage2.Height - 20);
      this.description2.Font = !(Program.mySettings.LanguageIdent == "tr") ? FontManager.GetFont("Arial", 9f, FontStyle.Regular) : FontManager.GetFont("Arial", 8f, FontStyle.Regular);
      this.description2.Color = Color.FromArgb((int) byte.MaxValue, 254, 220);
      this.featuresImage2.addControl((CustomSelfDrawPanel.CSDControl) this.description2);
      this.featuresOverImage2.Image = (Image) GFXLibrary.villageType_types[0];
      this.featuresOverImage2.Position = new Point(292, y + num1 + 630);
      this.featuresOverImage2.Visible = false;
      this.scrollArea.addControl((CustomSelfDrawPanel.CSDControl) this.featuresOverImage2);
      this.featuresLabela2.Text = SK.Text("NewVillage_Space", "Space") + ":";
      this.featuresLabela2.Position = new Point(5, 7 + num2);
      ...
      this.featuresLabela2.Color = Color.FromArgb((int) byte.MaxValue, 254, 220);
      this.featuresOverImage2.addControl((CustomSelfDrawPanel.CSDControl) this.featuresLabela2);
      textSize2 = this.featuresLabela2.TextSize;
      this.featuresLabeld2.Text = SK.Text("NewVillage_Medium", "Medium");
      this.featuresLabeld2.Position = new Point(5 + textSize2.Width + 5, 7 + num2);
      this.featuresLabeld2.Size = new Size(this.featuresImage2.Width - 10 - textSize2.Width - 5, this.featuresImage2.Height - 20);
      this.featuresLabeld2.Font = FontManager.GetFont("Arial", 9f, FontStyle.Regular);
      this.featuresLabeld2.Color = Color.FromArgb((int) byte.MaxValue, 254, 220);
      this.featuresOverImage2.addControl((CustomSelfDrawPanel.CSDControl) this.featuresLabeld2);
      this.featuresLabelb2.Text = SK.Text("NewVillage_Castle", "Castle natural defenses") + ":";
      this.featuresLabelb2.Position = new Point(5, 31 + num2);
      ...
      this.featuresLabelb2.Color = Color.FromArgb((int) byte.MaxValue, 254, 220);
      this.featuresOverImage2.addControl((CustomSelfDrawPanel.CSDControl) this.featuresLabelb2);
      textSize2 = this.featuresLabelb2.TextSize;
      this.featuresLabele2.Text = SK.Text("NewVillage_Medium", "Medium");
      this.featuresLabele2.Position = new Point(5 + textSize2.Width + 5, 31 + num2);
      this.featuresLabele2.Size = new Size(this.featuresImage2.Width - 10 - textSize2.Width - 5, this.featuresImage2.Height - 20);
      this.featuresLabele2.Font = FontManager.GetFont("Arial", 9f, FontStyle.Regular);
      this.featuresLabele2.Color = Color.FromArgb((int) byte.MaxValue, 254, 220);
      this.featuresOverImage2.addControl((CustomSelfDrawPanel.CSDControl) this.featuresLabele2);
      this.featuresLabelc2.Text = SK.Text("NewVillage_Production", "Production bonus to") + ":";
      this.featuresLabelc2.Position = new Point(5, 55 + num2);
      ...
      this.featuresLabelc2.Color = Color.FromArgb((int) byte.MaxValue, 254, 220);
      this.featuresOverImage2.addControl((CustomSelfDrawPanel.CSDControl) this.featuresLabelc2);
      textSize2 = this.featuresLabelc2.TextSize;
      this.featuresLabelf2.Text = SK.Text("NewVillage_None", "None");
      this.featuresLabelf2.Position = new Point(5 + textSize2.Width + 5, 55 + num2);
      this.featuresLabelf2.Size = new Size(this.featuresImage2.Width - 10 - textSize2.Width - 5, this.featuresImage2.Height - 20);
      this.featuresLabelf2.Font = FontManager.GetFont("Arial", 9f, FontStyle.Regular);
      this.featuresLabelf2.Color = Color.FromArgb((int) byte.MaxValue, 254, 220);
      this.featuresOverImage2.addControl((CustomSelfDrawPanel.CSDControl) this.featuresLabelf2);
      ...
      this.helpButton2.Position = new Point(this.featuresImage2.Position.X + 278, this.featuresImage2.Position.Y + num2 - 8);
      ...
      this.scrollArea.addControl((CustomSelfDrawPanel.CSDControl) this.helpButton2);
      ...
      this.scrollArea.addControl((CustomSelfDrawPanel.CSDControl) this.bigButton3);
      this.featuresImage3.Image = (Image) GFXLibrary.villageType_types[3];
      this.featuresImage3.Position = new Point(292, y + num1 + 720);
      this.featuresImage3.Visible = true;
      this.scrollArea.addControl((CustomSelfDrawPanel.CSDControl) this.featuresImage3);
      this.description3.Text = SK.Text("MapTypesDescription_Mountain_Peak", "Iron is plentiful in this mountain top stronghold.");
      this.description3.Position = new Point(5, 41 + num2);
      ...
      this.description3.Color = Color.FromArgb((int) byte.MaxValue, 254, 220);
      this.featuresImage3.addControl((CustomSelfDrawPanel.CSDControl) this.description3);
      this.featuresOverImage3.Image = (Image) GFXLibrary.villageType_types[0];
      this.featuresOverImage3.Position = new Point(292, y + num1 + 720);
      this.featuresOverImage3.Visible = false;
      this.scrollArea.addControl((CustomSelfDrawPanel.CSDControl) this.featuresOverImage3);
      this.featuresLabela3.Text = SK.Text("NewVillage_Space", "Space") + ":";
      this.featuresLabela3.Position = new Point(5, 7 + num2);
      ...
      this.featuresLabela3.Color = Color.FromArgb((int) byte.MaxValue, 254, 220);
      this.featuresOverImage3.addControl((CustomSelfDrawPanel.CSDControl) this.featuresLabela3);
      textSize2 = this.featuresLabela3.TextSize;
      this.featuresLabeld3.Text = SK.Text("NewVillage_Medium", "Medium");
      this.featuresLabeld3.Position = new Point(5 + textSize2.Width + 5, 7 + num2);
      this.featuresLabeld3.Size = new Size(this.featuresImage3.Width - 10 - textSize2.Width - 5, this.featuresImage3.Height - 20);
      this.featuresLabeld3.Font = FontManager.GetFont("Arial", 9f, FontStyle.Regular);
      this.featuresLabeld3.Color = Color.FromArgb((int) byte.MaxValue, 254, 220);
      this.featuresOverImage3.addControl((CustomSelfDrawPanel.CSDControl) this.featuresLabeld3);
      this.featuresLabelb3.Text = SK.Text("NewVillage_Castle", "Castle natural defenses") + ":";
      this.featuresLabelb3.Position = new Point(5, 31 + num2);
      ...
      this.featuresLabelb3.Color = Color.FromArgb((int) byte.MaxValue, 254, 220);
      this.featuresOverImage3.addControl((CustomSelfDrawPanel.CSDControl) this.featuresLabelb3);
      textSize2 = this.featuresLabelb3.TextSize;
      this.featuresLabele3.Text = SK.Text("NewVillage_High", "High");
      this.featuresLabele3.Position = new Point(5 + textSize2.Width + 5, 31 + num2);
      this.featuresLabele3.Size = new Size(this.featuresImage3.Width - 10 - textSize2.Width - 5, this.featuresImage3.Height - 20);
      this.featuresLabele3.Font = FontManager.GetFont("Arial", 9f, FontStyle.Regular);
      this.featuresLabele3.Color = Color.FromArgb((int) byte.MaxValue, 254, 220);
      this.featuresOverImage3.addControl((CustomSelfDrawPanel.CSDControl) this.featuresLabele3);
      this.featuresLabelc3.Text = SK.Text("NewVillage_Production", "Production bonus to") + ":";
      this.featuresLabelc3.Position = new Point(5, 55 + num2);
      ...
      this.featuresLabelc3.Color = Color.FromArgb((int) byte.MaxValue, 254, 220);
      this.featuresOverImage3.addControl((CustomSelfDrawPanel.CSDControl) this.featuresLabelc3);
      textSize2 = this.featuresLabelc3.TextSize;
      this.featuresLabelf3.Text = SK.Text("ResourceType_Iron", "Iron");
      this.featuresLabelf3.Position = new Point(5 + textSize2.Width + 5, 55 + num2);
      this.featuresLabelf3.Size = new Size(this.featuresImage3.Width - 10 - textSize2.Width - 5, this.featuresImage3.Height - 20);
      this.featuresLabelf3.Font = FontManager.GetFont("Arial", 9f, FontStyle.Regular);
      this.featuresLabelf3.Color = Color.FromArgb((int) byte.MaxValue, 254, 220);
      this.featuresOverImage3.addControl((CustomSelfDrawPanel.CSDControl) this.featuresLabelf3);
      ...
      this.helpButton3.Position = new Point(this.featuresImage3.Position.X + 278, this.featuresImage3.Position.Y + num2 - 8);
      ...
      this.scrollArea.addControl((CustomSelfDrawPanel.CSDControl) this.helpButton3);
      ...
      this.scrollArea.addControl((CustomSelfDrawPanel.CSDControl) this.bigButton4);
      this.featuresImage4.Image = (Image) GFXLibrary.villageType_types[5];
      this.featuresImage4.Position = new Point(292, y + num1 + 270);
      this.featuresImage4.Visible = true;
      this.scrollArea.addControl((CustomSelfDrawPanel.CSDControl) this.featuresImage4);
      ...
      this.description4.Position = new Point(5, 41 + num2);
      ...
      this.description4.Color = Color.FromArgb((int) byte.MaxValue, 254, 220);
      this.featuresImage4.addControl((CustomSelfDrawPanel.CSDControl) this.description4);
      this.featuresOverImage4.Image = (Image) GFXLibrary.villageType_types[0];
      this.featuresOverImage4.Position = new Point(292, y + num1 + 270);
      this.featuresOverImage4.Visible = false;
      this.scrollArea.addControl((CustomSelfDrawPanel.CSDControl) this.featuresOverImage4);
      this.featuresLabela4.Text = SK.Text("NewVillage_Space", "Space") + ":";
      this.featuresLabela4.Position = new Point(5, 7 + num2);
      ...
      this.featuresLabela4.Color = Color.FromArgb((int) byte.MaxValue, 254, 220);
      this.featuresOverImage4.addControl((CustomSelfDrawPanel.CSDControl) this.featuresLabela4);
      textSize2 = this.featuresLabela4.TextSize;
      this.featuresLabeld4.Text = SK.Text("NewVillage_High", "High");
      this.featuresLabeld4.Position = new Point(5 + textSize2.Width + 5, 7 + num2);
      this.featuresLabeld4.Size = new Size(this.featuresImage4.Width - 10 - textSize2.Width - 5, this.featuresImage4.Height - 20);
      this.featuresLabeld4.Font = FontManager.GetFont("Arial", 9f, FontStyle.Regular);
      this.featuresLabeld4.Color = Color.FromArgb((int) byte.MaxValue, 254, 220);
      this.featuresOverImage4.addControl((CustomSelfDrawPanel.CSDControl) this.featuresLabeld4);
      this.featuresLabelb4.Text = SK.Text("NewVillage_Castle", "Castle natural defenses") + ":";
      this.featuresLabelb4.Position = new Point(5, 31 + num2);
      ...
      this.featuresLabelb4.Color = Color.FromArgb((int) byte.MaxValue, 254, 220);
      this.featuresOverImage4.addControl((CustomSelfDrawPanel.CSDControl) this.featuresLabelb4);
      textSize2 = this.featuresLabelb4.TextSize;
      this.featuresLabele4.Text = SK.Text("NewVillage_None", "None");
      this.featuresLabele4.Position = new Point(5 + textSize2.Width + 5, 31 + num2);
      this.featuresLabele4.Size = new Size(this.featuresImage4.Width - 10 - textSize2.Width - 5, this.featuresImage4.Height - 20);
      this.featuresLabele4.Font = FontManager.GetFont("Arial", 9f, FontStyle.Regular);
      this.featuresLabele4.Color = Color.FromArgb((int) byte.MaxValue, 254, 220);
      this.featuresOverImage4.addControl((CustomSelfDrawPanel.CSDControl) this.featuresLabele4);
      this.featuresLabelc4.Text = SK.Text("NewVillage_Production", "Production bonus to") + ":";
      this.featuresLabelc4.Position = new Point(5, 55 + num2);
      ...
      this.featuresLabelc4.Color = Color.FromArgb((int) byte.MaxValue, 254, 220);
      this.featuresOverImage4.addControl((CustomSelfDrawPanel.CSDControl) this.featuresLabelc4);
      textSize2 = this.featuresLabelc4.TextSize;
      this.featuresLabelf4.Text = SK.Text("NewVillage_None", "None");
      this.featuresLabelf4.Position = new Point(5 + textSize2.Width + 5, 55 + num2);
      this.featuresLabelf4.Size = new Size(this.featuresImage4.Width - 10 - textSize2.Width - 5, this.featuresImage4.Height - 20);
      this.featuresLabelf4.Font = FontManager.GetFont("Arial", 9f, FontStyle.Regular);
      this.featuresLabelf4.Color = Color.FromArgb((int) byte.MaxValue, 254, 220);
      this.featuresOverImage4.addControl((CustomSelfDrawPanel.CSDControl) this.featuresLabelf4);
      ...
      this.helpButton4.Position = new Point(this.featuresImage4.Position.X + 278, this.featuresImage4.Position.Y + num2 - 8);
      ...
      this.scrollArea.addControl((CustomSelfDrawPanel.CSDControl) this.helpButton4);
      ...
      this.scrollArea.addControl((CustomSelfDrawPanel.CSDControl) this.bigButton5);
      this.featuresImage5.Image = (Image) GFXLibrary.villageType_types[4];
      this.featuresImage5.Position = new Point(292, y + num1 + 360);
      this.featuresImage5.Visible = true;
      this.scrollArea.addControl((CustomSelfDrawPanel.CSDControl) this.featuresImage5);
      ...
      this.description5.Position = new Point(5, 41 + num2);
      ...
      this.description5.Color = Color.FromArgb((int) byte.MaxValue, 254, 220);
      this.featuresImage5.addControl((CustomSelfDrawPanel.CSDControl) this.description5);
      this.featuresOverImage5.Image = (Image) GFXLibrary.villageType_types[0];
      this.featuresOverImage5.Position = new Point(292, y + num1 + 360);
      this.featuresOverImage5.Visible = false;
      this.scrollArea.addControl((CustomSelfDrawPanel.CSDControl) this.featuresOverImage5);
      this.featuresLabela5.Text = SK.Text("NewVillage_Space", "Space") + ":";
      this.featuresLabela5.Position = new Point(5, 7 + num2);
      ...
      this.featuresLabela5.Color = Color.FromArgb((int) byte.MaxValue, 254, 220);
      this.featuresOverImage5.addControl((CustomSelfDrawPanel.CSDControl) this.featuresLabela5);
      textSize2 = this.featuresLabela5.TextSize;
      this.featuresLabeld5.Text = SK.Text("NewVillage_High", "High");
      this.featuresLabeld5.Position = new Point(5 + textSize2.Width + 5, 7 + num2);
      this.featuresLabeld5.Size = new Size(this.featuresImage5.Width - 10 - textSize2.Width - 5, this.featuresImage5.Height - 20);
      this.featuresLabeld5.Font = FontManager.GetFont("Arial", 9f, FontStyle.Regular);
      this.featuresLabeld5.Color = Color.FromArgb((int) byte.MaxValue, 254, 220);
      this.featuresOverImage5.addControl((CustomSelfDrawPanel.CSDControl) this.featuresLabeld5);
      this.featuresLabelb5.Text = SK.Text("NewVillage_Castle", "Castle natural defenses") + ":";
      this.featuresLabelb5.Position = new Point(5, 31 + num2);
      ...
      this.featuresLabelb5.Color = Color.FromArgb((int) byte.MaxValue, 254, 220);
      this.featuresOverImage5.addControl((CustomSelfDrawPanel.CSDControl) this.featuresLabelb5);
      textSize2 = this.featuresLabelb5.TextSize;
      this.featuresLabele5.Text = SK.Text("NewVillage_None", "None");
      this.featuresLabele5.Position = new Point(5 + textSize2.Width + 5, 31 + num2);
      this.featuresLabele5.Size = new Size(this.featuresImage5.Width - 10 - textSize2.Width - 5, this.featuresImage5.Height - 20);
      this.featuresLabele5.Font = FontManager.GetFont("Arial", 9f, FontStyle.Regular);
      this.featuresLabele5.Color = Color.FromArgb((int) byte.MaxValue, 254, 220);
      this.featuresOverImage5.addControl((CustomSelfDrawPanel.CSDControl) this.featuresLabele5);
      this.featuresLabelc5.Text = SK.Text("NewVillage_Production", "Production bonus to") + ":";
      this.featuresLabelc5.Position = new Point(5, 55 + num2);
      ...
      this.featuresLabelc5.Color = Color.FromArgb((int) byte.MaxValue, 254, 220);
      this.featuresOverImage5.addControl((CustomSelfDrawPanel.CSDControl) this.featuresLabelc5);
      textSize2 = this.featuresLabelc5.TextSize;
      this.featuresLabelf5.Text = SK.Text("NewVillage_None", "None");
      this.featuresLabelf5.Position = new Point(5 + textSize2.Width + 5, 55 + num2);
      this.featuresLabelf5.Size = new Size(this.featuresImage5.Width - 10 - textSize2.Width - 5, this.featuresImage5.Height - 20);
      this.featuresLabelf5.Font = FontManager.GetFont("Arial", 9f, FontStyle.Regular);
      this.featuresLabelf5.Color = Color.FromArgb((int) byte.MaxValue, 254, 220);
      this.featuresOverImage5.addControl((CustomSelfDrawPanel.CSDControl) this.featuresLabelf5);
      ...
      this.helpButton5.Position = new Point(this.featuresImage5.Position.X + 278, this.featuresImage5.Position.Y + num2 - 8);
      ...
      this.scrollArea.addControl((CustomSelfDrawPanel.CSDControl) this.helpButton5);
      ...
      this.scrollArea.addControl((CustomSelfDrawPanel.CSDControl) this.bigButton6);
      this.featuresImage6.Image = (Image) GFXLibrary.villageType_types[6];
      this.featuresImage6.Position = new Point(292, y + num1 + 180);
      this.featuresImage6.Visible = true;
      this.scrollArea.addControl((CustomSelfDrawPanel.CSDControl) this.featuresImage6);
      ...
      this.description6.Position = new Point(5, 41 + num2);
      ...
      this.description6.Color = Color.FromArgb((int) byte.MaxValue, 254, 220);
      this.featuresImage6.addControl((CustomSelfDrawPanel.CSDControl) this.description6);
      this.featuresOverImage6.Image = (Image) GFXLibrary.villageType_types[0];
      this.featuresOverImage6.Position = new Point(292, y + num1 + 180);
      this.featuresOverImage6.Visible = false;
      this.scrollArea.addControl((CustomSelfDrawPanel.CSDControl) this.featuresOverImage6);
      this.featuresLabela6.Text = SK.Text("NewVillage_Space", "Space") + ":";
      this.featuresLabela6.Position = new Point(5, 7 + num2);
      ...
      this.featuresLabela6.Color = Color.FromArgb((int) byte.MaxValue, 254, 220);
      this.featuresOverImage6.addControl((CustomSelfDrawPanel.CSDControl) this.featuresLabela6);
      textSize2 = this.featuresLabela6.TextSize;
      this.featuresLabeld6.Text = SK.Text("NewVillage_Low", "Low");
      this.featuresLabeld6.Position = new Point(5 + textSize2.Width + 5, 7 + num2);
      this.featuresLabeld6.Size = new Size(this.featuresImage6.Width - 10 - textSize2.Width - 5, this.featuresImage6.Height - 20);
      this.featuresLabeld6.Font = FontManager.GetFont("Arial", 9f, FontStyle.Regular);
      this.featuresLabeld6.Color = Color.FromArgb((int) byte.MaxValue, 254, 220);
      this.featuresOverImage6.addControl((CustomSelfDrawPanel.CSDControl) this.featuresLabeld6);
      this.featuresLabelb6.Text = SK.Text("NewVillage_Castle", "Castle natural defenses") + ":";
      this.featuresLabelb6.Position = new Point(5, 31 + num2);
      ...
      this.featuresLabelb6.Color = Color.FromArgb((int) byte.MaxValue, 254, 220);
      this.featuresOverImage6.addControl((CustomSelfDrawPanel.CSDControl) this.featuresLabelb6);
      textSize2 = this.featuresLabelb6.TextSize;
      this.featuresLabele6.Text = SK.Text("NewVillage_None", "None");
      this.featuresLabele6.Position = new Point(5 + textSize2.Width + 5, 31 + num2);
      this.featuresLabele6.Size = new Size(this.featuresImage6.Width - 10 - textSize2.Width - 5, this.featuresImage6.Height - 20);
      this.featuresLabele6.Font = FontManager.GetFont("Arial", 9f, FontStyle.Regular);
      this.featuresLabele6.Color = Color.FromArgb((int) byte.MaxValue, 254, 220);
      this.featuresOverImage6.addControl((CustomSelfDrawPanel.CSDControl) this.featuresLabele6);
      this.featuresLabelc6.Text = SK.Text("NewVillage_Production", "Production bonus to") + ":";
      this.featuresLabelc6.Position = new Point(5, 55 + num2);
      ...
      this.featuresLabelc6.Color = Color.FromArgb((int) byte.MaxValue, 254, 220);
      this.featuresOverImage6.addControl((CustomSelfDrawPanel.CSDControl) this.featuresLabelc6);
      textSize2 = this.featuresLabelc6.TextSize;
      this.featuresLabelf6.Text = SK.Text("ResourceType_Clothes", "Clothes");
      this.featuresLabelf6.Position = new Point(5 + textSize2.Width + 5, 55 + num2);
      this.featuresLabelf6.Size = new Size(this.featuresImage6.Width - 10 - textSize2.Width - 5, this.featuresImage6.Height - 20);
      this.featuresLabelf6.Font = FontManager.GetFont("Arial", 9f, FontStyle.Regular);
      this.featuresLabelf6.Color = Color.FromArgb((int) byte.MaxValue, 254, 220);
      this.featuresOverImage6.addControl((CustomSelfDrawPanel.CSDControl) this.featuresLabelf6);
      ...
      this.helpButton6.Position = new Point(this.featuresImage6.Position.X + 278, this.featuresImage6.Position.Y + num2 - 8);
      ...
      this.scrollArea.addControl((CustomSelfDrawPanel.CSDControl) this.helpButton6);
      ...
      this.scrollArea.addControl((CustomSelfDrawPanel.CSDControl) this.bigButton7);
      this.featuresImage7.Image = (Image) GFXLibrary.villageType_types[7];
      this.featuresImage7.Position = new Point(292, y + num1 + 450);
      this.featuresImage7.Visible = true;
      this.scrollArea.addControl((CustomSelfDrawPanel.CSDControl) this.featuresImage7);
      this.description7.Text = SK.Text("MapTypesDescription_Marsh", "Pitch is abundant here, although wood and stone are scarce.");
      this.description7.Position = new Point(5, 41 + num2);
      ...
      this.description7.Color = Color.FromArgb((int) byte.MaxValue, 254, 220);
      this.featuresImage7.addControl((CustomSelfDrawPanel.CSDControl) this.description7);
      this.featuresOverImage7.Image = (Image) GFXLibrary.villageType_types[0];
      this.featuresOverImage7.Position = new Point(292, y + num1 + 450);
      this.featuresOverImage7.Visible = false;
      this.scrollArea.addControl((CustomSelfDrawPanel.CSDControl) this.featuresOverImage7);
      this.featuresLabela7.Text = SK.Text("NewVillage_Space", "Space") + ":";
      this.featuresLabela7.Position = new Point(5, 7 + num2);
      ...
      this.featuresLabela7.Color = Color.FromArgb((int) byte.MaxValue, 254, 220);
      this.featuresOverImage7.addControl((CustomSelfDrawPanel.CSDControl) this.featuresLabela7);
      textSize2 = this.featuresLabela7.TextSize;
      this.featuresLabeld7.Text = SK.Text("NewVillage_Low", "Low");
      this.featuresLabeld7.Position = new Point(5 + textSize2.Width + 5, 7 + num2);
      this.featuresLabeld7.Size = new Size(this.featuresImage7.Width - 10 - textSize2.Width - 5, this.featuresImage7.Height - 20);
      this.featuresLabeld7.Font = FontManager.GetFont("Arial", 9f, FontStyle.Regular);
      this.featuresLabeld7.Color = Color.FromArgb((int) byte.MaxValue, 254, 220);
      this.featuresOverImage7.addControl((CustomSelfDrawPanel.CSDControl) this.featuresLabeld7);
      this.featuresLabelb7.Text = SK.Text("NewVillage_Castle", "Castle natural defenses") + ":";
      this.featuresLabelb7.Position = new Point(5, 31 + num2);
      ...
      this.featuresLabelb7.Color = Color.FromArgb((int) byte.MaxValue, 254, 220);
      this.featuresOverImage7.addControl((CustomSelfDrawPanel.CSDControl) this.featuresLabelb7);
      textSize2 = this.featuresLabelb7.TextSize;
      this.featuresLabele7.Text = SK.Text("NewVillage_None", "None");
      this.featuresLabele7.Position = new Point(5 + textSize2.Width + 5, 31 + num2);
      this.featuresLabele7.Size = new Size(this.featuresImage7.Width - 10 - textSize2.Width - 5, this.featuresImage7.Height - 20);
      this.featuresLabele7.Font = FontManager.GetFont("Arial", 9f, FontStyle.Regular);
      this.featuresLabele7.Color = Color.FromArgb((int) byte.MaxValue, 254, 220);
      this.featuresOverImage7.addControl((CustomSelfDrawPanel.CSDControl) this.featuresLabele7);
      this.featuresLabelc7.Text = SK.Text("NewVillage_Production", "Production bonus to") + ":";
      this.featuresLabelc7.Position = new Point(5, 55 + num2);
      ...
      this.featuresLabelc7.Color = Color.FromArgb((int) byte.MaxValue, 254, 220);
      this.featuresOverImage7.addControl((CustomSelfDrawPanel.CSDControl) this.featuresLabelc7);
      textSize2 = this.featuresLabelc7.TextSize;
      this.featuresLabelf7.Text = SK.Text("ResourceType_Catapults", "Catapults") + ", " + SK.Text("ResourceType_Meat", "Meat");
      this.featuresLabelf7.Position = new Point(5 + textSize2.Width + 5, 55 + num2);
      this.featuresLabelf7.Size = new Size(this.featuresImage7.Width - 10 - textSize2.Width - 5, this.featuresImage7.Height - 20);
      this.featuresLabelf7.Font = FontManager.GetFont("Arial", 9f, FontStyle.Regular);
      this.featuresLabelf7.Color = Color.FromArgb((int) byte.MaxValue, 254, 220);
      this.featuresOverImage7.addControl((CustomSelfDrawPanel.CSDControl) this.featuresLabelf7);
      ...
      this.helpButton7.Position = new Point(this.featuresImage7.Position.X + 278, this.featuresImage7.Position.Y + num2 - 8);
      ...
      this.scrollArea.addControl((CustomSelfDrawPanel.CSDControl) this.helpButton7);
      ...
      this.scrollArea.addControl((CustomSelfDrawPanel.CSDControl) this.bigButton8);
      this.featuresImage8.Image = (Image) GFXLibrary.villageType_types[8];
      this.featuresImage8.Position = new Point(292, y + num1 + 540);
      this.featuresImage8.Visible = true;
      this.scrollArea.addControl((CustomSelfDrawPanel.CSDControl) this.featuresImage8);
      ...
      if (Program.mySettings.LanguageIdent == "de")
        this.description8.Position = new Point(5, 36 + num2);
      else
        this.description8.Position = new Point(5, 41 + num2);
      ...
      this.description8.Color = Color.FromArgb((int) byte.MaxValue, 254, 220);
      this.featuresImage8.addControl((CustomSelfDrawPanel.CSDControl) this.description8);
      this.featuresOverImage8.Image = (Image) GFXLibrary.villageType_types[0];
      this.featuresOverImage8.Position = new Point(292, y + num1 + 540);
      this.featuresOverImage8.Visible = false;
      this.scrollArea.addControl((CustomSelfDrawPanel.CSDControl) this.featuresOverImage8);
      this.featuresLabela8.Text = SK.Text("NewVillage_Space", "Space") + ":";
      this.featuresLabela8.Position = new Point(5, 7 + num2);
      ...
      this.featuresLabela8.Color = Color.FromArgb((int) byte.MaxValue, 254, 220);
      this.featuresOverImage8.addControl((CustomSelfDrawPanel.CSDControl) this.featuresLabela8);
      textSize2 = this.featuresLabela8.TextSize;
      this.featuresLabeld8.Text = SK.Text("NewVillage_VeryHigh", "Very High");
      this.featuresLabeld8.Position = new Point(5 + textSize2.Width + 5, 7 + num2);
      this.featuresLabeld8.Size = new Size(this.featuresImage8.Width - 10 - textSize2.Width - 5, this.featuresImage8.Height - 20);
      this.featuresLabeld8.Font = FontManager.GetFont("Arial", 9f, FontStyle.Regular);
      this.featuresLabeld8.Color = Color.FromArgb((int) byte.MaxValue, 254, 220);
      this.featuresOverImage8.addControl((CustomSelfDrawPanel.CSDControl) this.featuresLabeld8);
      this.featuresLabelb8.Text = SK.Text("NewVillage_Castle", "Castle natural defenses") + ":";
      this.featuresLabelb8.Position = new Point(5, 31 + num2);
      ...
      this.featuresLabelb8.Color = Color.FromArgb((int) byte.MaxValue, 254, 220);
      this.featuresOverImage8.addControl((CustomSelfDrawPanel.CSDControl) this.featuresLabelb8);
      textSize2 = this.featuresLabelb8.TextSize;
      this.featuresLabele8.Text = SK.Text("NewVillage_None", "None");
      this.featuresLabele8.Position = new Point(5 + textSize2.Width + 5, 31 + num2);
      this.featuresLabele8.Size = new Size(this.featuresImage8.Width - 10 - textSize2.Width - 5, this.featuresImage8.Height - 20);
      this.featuresLabele8.Font = FontManager.GetFont("Arial", 9f, FontStyle.Regular);
      this.featuresLabele8.Color = Color.FromArgb((int) byte.MaxValue, 254, 220);
      this.featuresOverImage8.addControl((CustomSelfDrawPanel.CSDControl) this.featuresLabele8);
      this.featuresLabelc8.Text = SK.Text("NewVillage_Production", "Production bonus to") + ":";
      this.featuresLabelc8.Position = new Point(5, 55 + num2);
      ...
      this.featuresLabelc8.Color = Color.FromArgb((int) byte.MaxValue, 254, 220);
      this.featuresOverImage8.addControl((CustomSelfDrawPanel.CSDControl) this.featuresLabelc8);
      textSize2 = this.featuresLabelc8.TextSize;
      this.featuresLabelf8.Text = SK.Text("NewVillage_Wheat", "Wheat") + ", " + SK.Text("ResourceType_Cheese", "Cheese");
      this.featuresLabelf8.Position = new Point(5 + textSize2.Width + 5, 55 + num2);
      this.featuresLabelf8.Size = new Size(this.featuresImage8.Width - 10 - textSize2.Width - 5, this.featuresImage8.Height - 20);
      this.featuresLabelf8.Font = FontManager.GetFont("Arial", 9f, FontStyle.Regular);
      this.featuresLabelf8.Color = Color.FromArgb((int) byte.MaxValue, 254, 220);
      this.featuresOverImage8.addControl((CustomSelfDrawPanel.CSDControl) this.featuresLabelf8);
      ...
      this.helpButton8.Position = new Point(this.featuresImage8.Position.X + 278, this.featuresImage8.Position.Y + num2 - 8);
      ...
      this.scrollArea.addControl((CustomSelfDrawPanel.CSDControl) this.helpButton8);
      this.bigButton9.ImageNorm = (Image) GFXLibrary.villageType_illustrations[16];
      this.bigButton9.ImageOver = (Image) GFXLibrary.villageType_illustrations[17];
      ...
      this.scrollArea.addControl((CustomSelfDrawPanel.CSDControl) this.bigButton9);
      this.featuresImage9.Image = (Image) GFXLibrary.villageType_types[9];
      this.featuresImage9.Position = new Point(292, y + num1 + 90);
      this.featuresImage9.Visible = true;
      this.scrollArea.addControl((CustomSelfDrawPanel.CSDControl) this.featuresImage9);
      ...
      if (Program.mySettings.LanguageIdent == "tr")
        this.description9.Position = new Point(5, 41 + num2 - 5);
      else
        this.description9.Position = new Point(5, 41 + num2);
      this.description9.Size = new Size(this.featuresImage2.Width - 10, this.featuresImage2.Height - 20);
      this.description9.Font = !(Program.mySettings.LanguageIdent == "tr") ? FontManager.GetFont("Arial", 9f, FontStyle.Regular) : FontManager.GetFont("Arial", 8f, FontStyle.Regular);
      this.description9.Color = Color.FromArgb((int) byte.MaxValue, 254, 220);
      this.featuresImage9.addControl((CustomSelfDrawPanel.CSDControl) this.description9);
      this.featuresOverImage9.Image = (Image) GFXLibrary.villageType_types[0];
      this.featuresOverImage9.Position = new Point(292, y + num1 + 90);
      this.featuresOverImage9.Visible = false;
      this.scrollArea.addControl((CustomSelfDrawPanel.CSDControl) this.featuresOverImage9);
      this.featuresLabela9.Text = SK.Text("NewVillage_Space", "Space") + ":";
      this.featuresLabela9.Position = new Point(5, 7 + num2);
      ...
      this.featuresLabela9.Color = Color.FromArgb((int) byte.MaxValue, 254, 220);
      this.featuresOverImage9.addControl((CustomSelfDrawPanel.CSDControl) this.featuresLabela9);
      textSize2 = this.featuresLabela9.TextSize;
      this.featuresLabeld9.Text = SK.Text("NewVillage_VeryHigh", "Very High");
      this.featuresLabeld9.Position = new Point(5 + textSize2.Width + 5, 7 + num2);
      this.featuresLabeld9.Size = new Size(this.featuresImage9.Width - 10 - textSize2.Width - 5, this.featuresImage9.Height - 20);
      this.featuresLabeld9.Font = FontManager.GetFont("Arial", 9f, FontStyle.Regular);
      this.featuresLabeld9.Color = Color.FromArgb((int) byte.MaxValue, 254, 220);
      this.featuresOverImage9.addControl((CustomSelfDrawPanel.CSDControl) this.featuresLabeld9);
      this.featuresLabelb9.Text = SK.Text("NewVillage_Castle", "Castle natural defenses") + ":";
      this.featuresLabelb9.Position = new Point(5, 31 + num2);
      ...
      this.featuresLabelb9.Color = Color.FromArgb((int) byte.MaxValue, 254, 220);
      this.featuresOverImage9.addControl((CustomSelfDrawPanel.CSDControl) this.featuresLabelb9);
      textSize2 = this.featuresLabelb9.TextSize;
      this.featuresLabele9.Text = SK.Text("NewVillage_None", "None");
      this.featuresLabele9.Position = new Point(5 + textSize2.Width + 5, 31 + num2);
      this.featuresLabele9.Size = new Size(this.featuresImage9.Width - 10 - textSize2.Width - 5, this.featuresImage9.Height - 20);
      this.featuresLabele9.Font = FontManager.GetFont("Arial", 9f, FontStyle.Regular);
      this.featuresLabele9.Color = Color.FromArgb((int) byte.MaxValue, 254, 220);
      this.featuresOverImage9.addControl((CustomSelfDrawPanel.CSDControl) this.featuresLabele9);
      this.featuresLabelc9.Text = SK.Text("NewVillage_Production", "Production bonus to") + ":";
      this.featuresLabelc9.Position = new Point(5, 55 + num2);
      ...
      this.featuresLabelc9.Color = Color.FromArgb((int) byte.MaxValue, 254, 220);
      this.featuresOverImage9.addControl((CustomSelfDrawPanel.CSDControl) this.featuresLabelc9);
      textSize2 = this.featuresLabelc9.TextSize;
      this.featuresLabelf9.Text = SK.Text("NewVillage_None", "None");
      this.featuresLabelf9.Position = new Point(5 + textSize2.Width + 5, 55 + num2);
      this.featuresLabelf9.Size = new Size(this.featuresImage9.Width - 10 - textSize2.Width - 5, this.featuresImage9.Height - 20);
      this.featuresLabelf9.Font = FontManager.GetFont("Arial", 9f, FontStyle.Regular);
      this.featuresLabelf9.Color = Color.FromArgb((int) byte.MaxValue, 254, 220);
      this.featuresOverImage9.addControl((CustomSelfDrawPanel.CSDControl) this.featuresLabelf9);
      ...
      this.helpButton9.Position = new Point(this.featuresImage9.Position.X + 278, this.featuresImage9.Position.Y + num2 - 8);
      ...
      this.scrollArea.addControl((CustomSelfDrawPanel.CSDControl) this.helpButton9);
      this.bigButton10.ImageNorm = (Image) GFXLibrary.villageType_illustrations[18];
      this.bigButton10.ImageOver = (Image) GFXLibrary.villageType_illustrations[19];
      ...
      this.scrollArea.addControl((CustomSelfDrawPanel.CSDControl) this.bigButton10);
      this.featuresImage10.Image = (Image) GFXLibrary.villageType_types[10];
      this.featuresImage10.Position = new Point(292, y + num1 + 810);
      this.featuresImage10.Visible = true;
      this.scrollArea.addControl((CustomSelfDrawPanel.CSDControl) this.featuresImage10);
      ...
      this.description10.Position = new Point(5, 41 + num2);
      ...
      this.description10.Color = Color.FromArgb((int) byte.MaxValue, 254, 220);
      this.featuresImage10.addControl((CustomSelfDrawPanel.CSDControl) this.description10);
      this.featuresOverImage10.Image = (Image) GFXLibrary.villageType_types[0];
      this.featuresOverImage10.Position = new Point(292, y + num1 + 810);
      this.featuresOverImage10.Visible = false;
      this.scrollArea.addControl((CustomSelfDrawPanel.CSDControl) this.featuresOverImage10);
      this.featuresLabela10.Text = SK.Text("NewVillage_Space", "Space") + ":";
      this.featuresLabela10.Position = new Point(5, 7 + num2);
      ...
      this.featuresLabela10.Color = Color.FromArgb((int) byte.MaxValue, 254, 220);
      this.featuresOverImage10.addControl((CustomSelfDrawPanel.CSDControl) this.featuresLabela10);
      textSize2 = this.featuresLabela10.TextSize;
      this.featuresLabeld10.Text = SK.Text("NewVillage_Low", "Low");
      this.featuresLabeld10.Position = new Point(5 + textSize2.Width + 5, 7 + num2);
      this.featuresLabeld10.Size = new Size(this.featuresImage10.Width - 10 - textSize2.Width - 5, this.featuresImage10.Height - 20);
      this.featuresLabeld10.Font = FontManager.GetFont("Arial", 9f, FontStyle.Regular);
      this.featuresLabeld10.Color = Color.FromArgb((int) byte.MaxValue, 254, 220);
      this.featuresOverImage10.addControl((CustomSelfDrawPanel.CSDControl) this.featuresLabeld10);
      this.featuresLabelb10.Text = SK.Text("NewVillage_Castle", "Castle natural defenses") + ":";
      this.featuresLabelb10.Position = new Point(5, 31 + num2);
      ...
      this.featuresLabelb10.Color = Color.FromArgb((int) byte.MaxValue, 254, 220);
      this.featuresOverImage10.addControl((CustomSelfDrawPanel.CSDControl) this.featuresLabelb10);
      textSize2 = this.featuresLabelb10.TextSize;
      this.featuresLabele10.Text = SK.Text("NewVillage_VeryHigh", "Very High");
      this.featuresLabele10.Position = new Point(5 + textSize2.Width + 5, 31 + num2);
      this.featuresLabele10.Size = new Size(this.featuresImage10.Width - 10 - textSize2.Width - 5, this.featuresImage10.Height - 20);
      this.featuresLabele10.Font = FontManager.GetFont("Arial", 9f, FontStyle.Regular);
      this.featuresLabele10.Color = Color.FromArgb((int) byte.MaxValue, 254, 220);
      this.featuresOverImage10.addControl((CustomSelfDrawPanel.CSDControl) this.featuresLabele10);
      this.featuresLabelc10.Text = SK.Text("NewVillage_Production", "Production bonus to") + ":";
      this.featuresLabelc10.Position = new Point(5, 55 + num2);
      ...
      this.featuresLabelc10.Color = Color.FromArgb((int) byte.MaxValue, 254, 220);
      this.featuresOverImage10.addControl((CustomSelfDrawPanel.CSDControl) this.featuresLabelc10);
      textSize2 = this.featuresLabelc10.TextSize;
      ...
      this.featuresLabelf10.Position = new Point(5 + textSize2.Width + 5, 55 + num2);
      this.featuresLabelf10.Size = new Size(this.featuresImage10.Width - 10 - textSize2.Width - 5, this.featuresImage10.Height - 20);
      this.featuresLabelf10.Font = FontManager.GetFont("Arial", 9f, FontStyle.Regular);
      this.featuresLabelf10.Color = Color.FromArgb((int) byte.MaxValue, 254, 220);
      this.featuresOverImage10.addControl((CustomSelfDrawPanel.CSDControl) this.featuresLabelf10);
      ...
      this.helpButton10.Position = new Point(this.featuresImage10.Position.X + 278, this.featuresImage10.Position.Y + num2 - 8);
      ...
      this.scrollArea.addControl((CustomSelfDrawPanel.CSDControl) this.helpButton10);
      if (this.buying)
      {
        ...
        this.mainBackgroundImage.addControl((CustomSelfDrawPanel.CSDControl) this.peaceTimeCheck);
    ...
    private void scrollBarMoved()
    {
      ...
      this.scrollArea.Position = new Point(this.scrollArea.X, 107 - y);
    ...
    private void buyVillage()
    {
      ...
      if (this.buying)
      {
        ...
        RemoteServices.Instance.BuyVillage(InterfaceMgr.Instance.getSelectedMenuVillage(), this.m_villageID, data, GameEngine.Instance.World.CurrentVillageFactionsPos, peaceTime);
        this.closeClick();
      }
      else
      {
    ...
    private void buyVillageCallback(BuyVillage_ReturnType returnData)
    {
      ...
      {
        int num = (int) MyMessageBox.Show(ErrorCodes.getErrorString(returnData.m_errorCode, returnData.m_errorID), SK.Text("BuyVillagePopup_Error", "BuyVillage Error"));
      }
    }
    ...
    private void convertVillageCallback(ConvertVillage_ReturnType returnData)
    {
      if (returnData.Success)
      {
        ...
        else
        {
          ...
          int num = (int) MyMessageBox.Show(SK.Text("MENU_Cannot_Change_Type", "You cannot change this Village's Type for") + " : " + str, SK.Text("MENU_Change_Type_Error", "Change Village Type Error"));
        }
      }
      else if (returnData.m_errorCode == ErrorCodes.ErrorCode.CANT_ABANDON_WITH_INCOMING_ATTACKS)
      {
        int num1 = (int) MyMessageBox.Show(SK.Text("MENU_Cannot_Change_Incoming_Attacks", "You cannot change your village type while you have incoming attacks"), SK.Text("MENU_Change_Type_Error", "Change Village Type Error"));
      }
      else
      {
        int num2 = (int) MyMessageBox.Show(ErrorCodes.getErrorString(returnData.m_errorCode, returnData.m_errorID), SK.Text("MENU_Change_Type_Error", "Change Village Type Error"));
      }
    }
