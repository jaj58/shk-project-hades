...
// Type: Kingdoms.CapitalDonateResourcesPanel2
...
namespace Kingdoms
{
  public class CapitalDonateResourcesPanel2 : CustomSelfDrawPanel, IDockableControl
  {
    ...
    public static CapitalDonateResourcesPanel2 instance = (CapitalDonateResourcesPanel2) null;
    ...
    private void InitializeComponent()
    {
      ...
      this.Name = "CapitalDonateResourcesPanel22";
    ...
    public void init(int villageID, VillageMapBuilding selectedBuilding)
    {
      ...
      CustomSelfDrawPanel.WikiLinkControl.init((CustomSelfDrawPanel.CSDControl) this.mainBackgroundArea, 42, new Point(898, 10));
      ...
      this.mainBackgroundArea.addControl((CustomSelfDrawPanel.CSDControl) this.topWindow);
      ...
      this.topWindow.addControl((CustomSelfDrawPanel.CSDControl) this.buildingImage);
      int y = 11;
      ...
      this.buildingTypeName.Position = new Point(96, y);
      ...
      this.topWindow.addControl((CustomSelfDrawPanel.CSDControl) this.buildingTypeName);
      ...
      this.currentLevelName.Position = new Point(336, y);
      ...
      this.topWindow.addControl((CustomSelfDrawPanel.CSDControl) this.currentLevelName);
      ...
      this.lblCurrentEffectLevelLabel.Position = new Point(96, y + 25);
      ...
      this.topWindow.addControl((CustomSelfDrawPanel.CSDControl) this.lblCurrentEffectLevelLabel);
      ...
      this.lblCurrentLevelEffect.Position = new Point(261, y + 25);
      ...
      this.topWindow.addControl((CustomSelfDrawPanel.CSDControl) this.lblCurrentLevelEffect);
      ...
      this.lblNextLevelEffectLabel.Position = new Point(96, y + 61);
      ...
      this.topWindow.addControl((CustomSelfDrawPanel.CSDControl) this.lblNextLevelEffectLabel);
      ...
      this.lblNextLevelEffect.Position = new Point(261, y + 61);
      ...
      this.topWindow.addControl((CustomSelfDrawPanel.CSDControl) this.lblNextLevelEffect);
      ...
      this.leftWindow.addControl((CustomSelfDrawPanel.CSDControl) this.exchangeNameBar);
      ...
      this.sendSubWindow.addControl((CustomSelfDrawPanel.CSDControl) this.sendNumberPackets);
      ...
      this.villageSelectVillage14.Position = new Point(3, (int) byte.MaxValue);
    ...
    public void updateScreenInfo(
      VillageMapBuilding selectedBuilding,
      VillageMap vm,
      bool resetRadios)
    {
      ...
      int rank = vm.m_parishCapitalResearchData.getCapitalResourceFromBuildingType(selectedBuilding.buildingType);
      ...
      int fromBuildingType = ResearchData.getCapitalResearchFromBuildingType(selectedBuilding.buildingType);
      int numLevels = ResearchData.getNumLevels(fromBuildingType);
      ...
      if (GameEngine.Instance.World.SeventhAgeWorld)
        numLevels = ResearchData.seventhAgeCapitalResearchLevels(numLevels, fromBuildingType);
      else if (GameEngine.Instance.World.FourthAgeWorld)
        numLevels = ResearchData.fourthAgeCapitalResearchLevels(numLevels, fromBuildingType);
      else if (GameEngine.Instance.World.ThirdAgeWorld)
        numLevels = ResearchData.thirdAgeCapitalResearchLevels(numLevels, fromBuildingType);
      if (rank >= numLevels)
      {
      ...
      this.storedHeadingLabel.Text = SK.Text("DonateScreen_For_Level", "For Level") + " : " + (rank + 1).ToString();
      this.sendAllowed = true;
      BaseImage baseImage = GFXLibrary.townbuilding_archeryrange_normal;
      ...
      this.buildingImage.Image = (Image) baseImage;
      this.buildingTypeName.Text = VillageBuildingsData.getBuildingName(selectedBuilding.buildingType);
      this.currentLevelName.Text = SK.Text("DonateScreen_Current_Level", "Current Level") + " : " + rank.ToString();
      switch (selectedBuilding.buildingType)
      {
        case 79:
        case 80:
        ...
        case 101:
        case 102:
          if (rank < ResearchData.ParishResearchIncreases_Guilds.Length && rank < numLevels)
          {
            this.lblNextLevelEffectLabel.Visible = true;
            this.lblNextLevelEffect.Visible = true;
            this.lblNextLevelEffect.Text = "+" + ((int) ((ResearchData.ParishResearchIncreases_Guilds[rank + 1] - 1.0 + 9.9999997473787516E-06) * 100.0)).ToString() + "%";
          }
          if (rank > 0)
          {
            if (rank >= ResearchData.ParishResearchIncreases_Guilds.Length)
              rank = ResearchData.ParishResearchIncreases_Guilds.Length - 1;
            this.lblCurrentEffectLevelLabel.Visible = true;
            this.lblCurrentLevelEffect.Visible = true;
            this.lblCurrentLevelEffect.Text = "+" + ((int) ((ResearchData.ParishResearchIncreases_Guilds[rank] - 1.0 + 9.9999997473787516E-06) * 100.0)).ToString() + "%";
            break;
          }
          break;
        case 103:
        ...
        case 105:
          if (rank < 10)
          {
            this.lblNextLevelEffect.Text = SK.Text("CapitalDonateResourcesPanel_Keep_Level", "Keep Level") + " : " + (rank + 1).ToString();
            this.lblNextLevelEffectLabel.Visible = true;
            this.lblNextLevelEffect.Visible = true;
          }
          if (rank > 0)
          {
            this.lblCurrentLevelEffect.Text = SK.Text("CapitalDonateResourcesPanel_Keep_Level", "Keep Level") + " : " + rank.ToString();
            this.lblCurrentEffectLevelLabel.Visible = true;
            this.lblCurrentLevelEffect.Visible = true;
            break;
          }
        ...
        case 106:
          if (rank < 10)
          {
            ...
            CustomSelfDrawPanel.CSDLabel lblNextLevelEffect1 = this.lblNextLevelEffect;
            lblNextLevelEffect1.Text = lblNextLevelEffect1.Text + SK.Text("CapitalDonateResourcesPanel_Boost_To_Armour", "Boost to armour") + " : ";
            double num = (1.0 - (double) ResearchData.defencesResearch[rank + 1]) * 100.0;
            CustomSelfDrawPanel.CSDLabel lblNextLevelEffect2 = this.lblNextLevelEffect;
            lblNextLevelEffect2.Text = lblNextLevelEffect2.Text + ((int) num).ToString() + "%";
            this.lblNextLevelEffectLabel.Visible = true;
            this.lblNextLevelEffect.Visible = true;
          }
          if (rank > 0)
          {
            ...
            CustomSelfDrawPanel.CSDLabel currentLevelEffect1 = this.lblCurrentLevelEffect;
            currentLevelEffect1.Text = currentLevelEffect1.Text + SK.Text("CapitalDonateResourcesPanel_Boost_To_Armour", "Boost to armour") + " : ";
            double num = (1.0 - (double) ResearchData.defencesResearch[rank]) * 100.0;
            CustomSelfDrawPanel.CSDLabel currentLevelEffect2 = this.lblCurrentLevelEffect;
            currentLevelEffect2.Text = currentLevelEffect2.Text + ((int) num).ToString() + "%";
            this.lblCurrentEffectLevelLabel.Visible = true;
            this.lblCurrentLevelEffect.Visible = true;
            break;
          }
        ...
        case 107:
          if (rank < 10)
          {
            this.lblNextLevelEffectLabel.Visible = true;
            this.lblNextLevelEffect.Visible = true;
            this.lblNextLevelEffect.Text = SK.Text("CapitalDonateResourcesPanel_Knights", "Knights") + " : " + (rank + 1).ToString();
          }
          if (rank > 0)
          {
            this.lblCurrentEffectLevelLabel.Visible = true;
            this.lblCurrentLevelEffect.Visible = true;
            this.lblNextLevelEffect.Text = SK.Text("CapitalDonateResourcesPanel_Knights", "Knights") + " : " + rank.ToString();
            break;
          }
          break;
        case 109:
          if (rank < 10 && rank > 1)
          {
            this.lblNextLevelEffectLabel.Visible = true;
            this.lblNextLevelEffect.Visible = true;
            this.lblNextLevelEffect.Text = "+" + ((int) (((double) ResearchData.conscriptionBonus[rank + 1] - 1.0 + 9.9999997473787516E-06) * 100.0)).ToString() + "%";
          }
          if (rank > 0)
          {
            this.lblCurrentEffectLevelLabel.Visible = true;
            this.lblCurrentLevelEffect.Visible = true;
            this.lblCurrentLevelEffect.Text = "+" + ((int) (((double) ResearchData.conscriptionBonus[rank] - 1.0 + 9.9999997473787516E-06) * 100.0)).ToString() + "%";
            break;
          }
          break;
        case 110:
          if (rank < 10 && rank > 1)
          {
            this.lblNextLevelEffectLabel.Visible = true;
            this.lblNextLevelEffect.Visible = true;
            this.lblNextLevelEffect.Text = "+" + ((int) (((double) ResearchData.longBowBonus[rank + 1] - 1.0 + 9.9999997473787516E-06) * 100.0)).ToString() + "%";
          }
          if (rank > 0)
          {
            this.lblCurrentEffectLevelLabel.Visible = true;
            this.lblCurrentLevelEffect.Visible = true;
            this.lblCurrentLevelEffect.Text = "+" + ((int) (((double) ResearchData.longBowBonus[rank] - 1.0 + 9.9999997473787516E-06) * 100.0)).ToString() + "%";
            break;
          }
          break;
        case 111:
          if (rank < 10 && rank > 1)
          {
            this.lblNextLevelEffectLabel.Visible = true;
            this.lblNextLevelEffect.Visible = true;
            this.lblNextLevelEffect.Text = "+" + ((int) (((double) ResearchData.pikeBonus[rank + 1] - 1.0 + 9.9999997473787516E-06) * 100.0)).ToString() + "%";
          }
          if (rank > 0)
          {
            this.lblCurrentEffectLevelLabel.Visible = true;
            this.lblCurrentLevelEffect.Visible = true;
            this.lblCurrentLevelEffect.Text = "+" + ((int) (((double) ResearchData.pikeBonus[rank] - 1.0 + 9.9999997473787516E-06) * 100.0)).ToString() + "%";
            break;
          }
          break;
        case 112:
          if (rank < 10 && rank > 1)
          {
            this.lblNextLevelEffectLabel.Visible = true;
            this.lblNextLevelEffect.Visible = true;
            this.lblNextLevelEffect.Text = "+" + ((int) (((double) ResearchData.swordBonus[rank + 1] - 1.0 + 9.9999997473787516E-06) * 100.0)).ToString() + "%";
          }
          if (rank > 0)
          {
            this.lblCurrentEffectLevelLabel.Visible = true;
            this.lblCurrentLevelEffect.Visible = true;
            this.lblCurrentLevelEffect.Text = "+" + ((int) (((double) ResearchData.swordBonus[rank] - 1.0 + 9.9999997473787516E-06) * 100.0)).ToString() + "%";
            break;
          }
          break;
        case 113:
          if (rank < 10 && rank > 1)
          {
            this.lblNextLevelEffectLabel.Visible = true;
            this.lblNextLevelEffect.Visible = true;
            this.lblNextLevelEffect.Text = "+" + ((int) ((1.0 - ResearchData.catapultFireRate[rank + 1] + 9.9999997473787516E-06) * 100.0)).ToString() + "%";
          }
          if (rank > 0)
          {
            this.lblCurrentEffectLevelLabel.Visible = true;
            this.lblCurrentLevelEffect.Visible = true;
            this.lblCurrentLevelEffect.Text = "+" + ((int) ((1.0 - ResearchData.catapultFireRate[rank] + 9.9999997473787516E-06) * 100.0)).ToString() + "%";
            break;
          }
          break;
        case 115:
          if (rank < numLevels)
          {
            this.lblNextLevelEffectLabel.Visible = true;
            this.lblNextLevelEffect.Visible = true;
            this.lblNextLevelEffect.Text = SK.Text("CapitalDonateResourcesPanel_MilitarySchool", "Bombards") + " : " + (rank + 1).ToString();
          }
          if (rank > 0)
          {
            this.lblCurrentEffectLevelLabel.Visible = true;
            this.lblCurrentLevelEffect.Visible = true;
            this.lblCurrentLevelEffect.Text = SK.Text("CapitalDonateResourcesPanel_MilitarySchool", "Bombards") + " : " + rank.ToString();
            break;
          }
          break;
        case 117:
          if (rank < 10)
          {
            int num1 = vm.numCapitalBuildings();
            int num2;
            switch (num1)
            {
              case 0:
            ...
            int minutes = (int) ((double) (num2 * 60) * ResearchData.ParishTownHallIncreases_Guilds[rank + 1]);
          ...
          if (rank > 0)
          {
            int num3 = vm.numCapitalBuildings();
            int num4;
            switch (num3)
            {
              case 0:
            ...
            int minutes = (int) ((double) (num4 * 60) * ResearchData.ParishTownHallIncreases_Guilds[rank]);
            if (GameEngine.Instance.LocalWorldData.Alternate_Ruleset == 1)
              minutes /= 4;
            TimeSpan timeSpan = new TimeSpan(0, minutes, 0);
            this.lblCurrentEffectLevelLabel.Visible = true;
            this.lblCurrentLevelEffect.Visible = true;
            this.lblCurrentLevelEffect.Text = SK.Text("CapitalDonateResourcesPanel_Construction_Time", "Construction Time") + " : " + VillageMap.createBuildTimeString((int) timeSpan.TotalSeconds);
            break;
          }
          break;
        case 118:
          if (rank < numLevels)
          {
            this.lblNextLevelEffectLabel.Visible = true;
            this.lblNextLevelEffect.Visible = true;
            this.lblNextLevelEffect.Text = SK.Text("CapitalDonateResourcesPanel_Faith_Points_Per_Day", "Faith Points Per Day") + " : " + ((rank + 1) * 6).ToString();
          }
          if (rank > 0)
          {
            this.lblCurrentEffectLevelLabel.Visible = true;
            this.lblCurrentLevelEffect.Visible = true;
            this.lblCurrentLevelEffect.Text = SK.Text("CapitalDonateResourcesPanel_Faith_Points_Per_Day", "Faith Points Per Day") + " : " + (rank * 6).ToString();
            break;
          }
          break;
        case 119:
          if (rank < numLevels)
          {
            this.lblNextLevelEffectLabel.Visible = true;
            this.lblNextLevelEffect.Visible = true;
            this.lblNextLevelEffect.Text = SK.Text("CapitalDonateResourcesPanel_Popularity_Honour_Multiplier", "Popularity-Honour Multiplier") + " : +" + (rank + 1).ToString();
          }
          if (rank > 0)
          {
            this.lblCurrentEffectLevelLabel.Visible = true;
            this.lblCurrentLevelEffect.Visible = true;
            this.lblCurrentLevelEffect.Text = SK.Text("CapitalDonateResourcesPanel_Popularity_Honour_Multiplier", "Popularity-Honour Multiplier") + " : +" + rank.ToString();
            break;
          }
          break;
        case 121:
          if (rank < numLevels)
          {
            this.lblNextLevelEffectLabel.Visible = true;
            this.lblNextLevelEffect.Visible = true;
            this.lblNextLevelEffect.Text = SK.Text("CapitalDonateResourcesPanel_Turrets", "Turrets") + " : " + (rank + 1).ToString();
          }
          if (rank > 0)
          {
            this.lblCurrentEffectLevelLabel.Visible = true;
            this.lblCurrentLevelEffect.Visible = true;
            this.lblCurrentLevelEffect.Text = SK.Text("CapitalDonateResourcesPanel_Turrets", "Turrets") + " : " + rank.ToString();
            break;
          }
          break;
        case 122:
          if (rank < numLevels)
          {
            this.lblNextLevelEffectLabel.Visible = true;
            this.lblNextLevelEffect.Visible = true;
            this.lblNextLevelEffect.Text = SK.Text("CapitalDonateResourcesPanel_Tunneller_Peasants", "Tunneller Peasants") + " : " + ((rank + 1) * 5).ToString();
          }
          if (rank > 0)
          {
            this.lblCurrentEffectLevelLabel.Visible = true;
            this.lblCurrentLevelEffect.Visible = true;
            this.lblCurrentLevelEffect.Text = SK.Text("CapitalDonateResourcesPanel_Tunneller_Peasants", "Tunneller Peasants") + " : " + (rank * 5).ToString();
            break;
          }
          break;
        case 123:
          if (rank < numLevels)
          {
            this.lblNextLevelEffectLabel.Visible = true;
            this.lblNextLevelEffect.Visible = true;
            this.lblNextLevelEffect.Text = SK.Text("CapitalDonateResourcesPanel_Ballista_Towers", "Ballista Towers") + " : " + (rank + 1).ToString();
          }
          if (rank > 0)
          {
            this.lblCurrentEffectLevelLabel.Visible = true;
            this.lblCurrentLevelEffect.Visible = true;
            this.lblCurrentLevelEffect.Text = SK.Text("CapitalDonateResourcesPanel_Ballista_Towers", "Ballista Towers") + " : " + rank.ToString();
            break;
          }
          break;
      }
      ...
      int requiredResourceType1 = VillageBuildingsData.getRequiredResourceType(selectedBuilding.buildingType, 0);
      if (requiredResourceType1 >= 0 && selectedBuilding.capitalResourceLevels.Length > 0)
      {
        int resourceTypeLevel = VillageBuildingsData.getRequiredResourceTypeLevel(selectedBuilding.buildingType, 0, rank, GameEngine.Instance.World.ThirdAgeWorld, GameEngine.Instance.World.FourthAgeWorld, GameEngine.Instance.World.FifthAgeWorld, GameEngine.Instance.World.SeventhAgeWorld, GameEngine.Instance.LocalWorldData.EraWorld);
        if (resourceTypeLevel > 0)
        {
          this.highlightLine1.Visible = true;
          this.storedLabel1.Text = selectedBuilding.capitalResourceLevels[0].ToString("N", (IFormatProvider) nfi) + " / ";
          this.priceLabel1.Text = resourceTypeLevel.ToString("N", (IFormatProvider) nfi);
          this.setDonateRowInfo(0, requiredResourceType1);
          this.currentLevelsNeeded[0, 0] = selectedBuilding.capitalResourceLevels[0];
          this.currentLevelsNeeded[0, 1] = resourceTypeLevel;
        }
      }
      int requiredResourceType2 = VillageBuildingsData.getRequiredResourceType(selectedBuilding.buildingType, 1);
      if (requiredResourceType2 >= 0 && selectedBuilding.capitalResourceLevels.Length > 1)
      {
        int resourceTypeLevel = VillageBuildingsData.getRequiredResourceTypeLevel(selectedBuilding.buildingType, 1, rank, GameEngine.Instance.World.ThirdAgeWorld, GameEngine.Instance.World.FourthAgeWorld, GameEngine.Instance.World.FifthAgeWorld, GameEngine.Instance.World.SeventhAgeWorld, GameEngine.Instance.LocalWorldData.EraWorld);
        if (resourceTypeLevel > 0)
        {
          this.highlightLine2.Visible = true;
          this.storedLabel2.Text = selectedBuilding.capitalResourceLevels[1].ToString("N", (IFormatProvider) nfi) + " / ";
          this.priceLabel2.Text = resourceTypeLevel.ToString("N", (IFormatProvider) nfi);
          this.setDonateRowInfo(1, requiredResourceType2);
          this.currentLevelsNeeded[1, 0] = selectedBuilding.capitalResourceLevels[1];
          this.currentLevelsNeeded[1, 1] = resourceTypeLevel;
        }
      }
      int requiredResourceType3 = VillageBuildingsData.getRequiredResourceType(selectedBuilding.buildingType, 2);
      if (requiredResourceType3 >= 0 && selectedBuilding.capitalResourceLevels.Length > 2)
      {
        int resourceTypeLevel = VillageBuildingsData.getRequiredResourceTypeLevel(selectedBuilding.buildingType, 2, rank, GameEngine.Instance.World.ThirdAgeWorld, GameEngine.Instance.World.FourthAgeWorld, GameEngine.Instance.World.FifthAgeWorld, GameEngine.Instance.World.SeventhAgeWorld, GameEngine.Instance.LocalWorldData.EraWorld);
        if (resourceTypeLevel > 0)
        {
          this.highlightLine3.Visible = true;
          this.storedLabel3.Text = selectedBuilding.capitalResourceLevels[2].ToString("N", (IFormatProvider) nfi) + " / ";
          this.priceLabel3.Text = resourceTypeLevel.ToString("N", (IFormatProvider) nfi);
          this.setDonateRowInfo(2, requiredResourceType3);
          this.currentLevelsNeeded[2, 0] = selectedBuilding.capitalResourceLevels[2];
          this.currentLevelsNeeded[2, 1] = resourceTypeLevel;
        }
      }
      int requiredResourceType4 = VillageBuildingsData.getRequiredResourceType(selectedBuilding.buildingType, 3);
      if (requiredResourceType4 >= 0 && selectedBuilding.capitalResourceLevels.Length > 3)
      {
        int resourceTypeLevel = VillageBuildingsData.getRequiredResourceTypeLevel(selectedBuilding.buildingType, 3, rank, GameEngine.Instance.World.ThirdAgeWorld, GameEngine.Instance.World.FourthAgeWorld, GameEngine.Instance.World.FifthAgeWorld, GameEngine.Instance.World.SeventhAgeWorld, GameEngine.Instance.LocalWorldData.EraWorld);
        if (resourceTypeLevel > 0)
        {
          this.highlightLine4.Visible = true;
          this.storedLabel4.Text = selectedBuilding.capitalResourceLevels[3].ToString("N", (IFormatProvider) nfi) + " / ";
          this.priceLabel4.Text = resourceTypeLevel.ToString("N", (IFormatProvider) nfi);
          this.setDonateRowInfo(3, requiredResourceType4);
          this.currentLevelsNeeded[3, 0] = selectedBuilding.capitalResourceLevels[3];
          this.currentLevelsNeeded[3, 1] = resourceTypeLevel;
        }
      }
      int requiredResourceType5 = VillageBuildingsData.getRequiredResourceType(selectedBuilding.buildingType, 4);
      if (requiredResourceType5 >= 0 && selectedBuilding.capitalResourceLevels.Length > 4)
      {
        int resourceTypeLevel = VillageBuildingsData.getRequiredResourceTypeLevel(selectedBuilding.buildingType, 4, rank, GameEngine.Instance.World.ThirdAgeWorld, GameEngine.Instance.World.FourthAgeWorld, GameEngine.Instance.World.FifthAgeWorld, GameEngine.Instance.World.SeventhAgeWorld, GameEngine.Instance.LocalWorldData.EraWorld);
        if (resourceTypeLevel > 0)
        {
          this.highlightLine5.Visible = true;
          this.storedLabel5.Text = selectedBuilding.capitalResourceLevels[4].ToString("N", (IFormatProvider) nfi) + " / ";
          this.priceLabel5.Text = resourceTypeLevel.ToString("N", (IFormatProvider) nfi);
          this.setDonateRowInfo(4, requiredResourceType5);
          this.currentLevelsNeeded[4, 0] = selectedBuilding.capitalResourceLevels[4];
          this.currentLevelsNeeded[4, 1] = resourceTypeLevel;
        }
      }
      int requiredResourceType6 = VillageBuildingsData.getRequiredResourceType(selectedBuilding.buildingType, 5);
      if (requiredResourceType6 >= 0 && selectedBuilding.capitalResourceLevels.Length > 5)
      {
        int resourceTypeLevel = VillageBuildingsData.getRequiredResourceTypeLevel(selectedBuilding.buildingType, 5, rank, GameEngine.Instance.World.ThirdAgeWorld, GameEngine.Instance.World.FourthAgeWorld, GameEngine.Instance.World.FifthAgeWorld, GameEngine.Instance.World.SeventhAgeWorld, GameEngine.Instance.LocalWorldData.EraWorld);
        if (resourceTypeLevel > 0)
        {
          this.highlightLine6.Visible = true;
          this.storedLabel6.Text = selectedBuilding.capitalResourceLevels[5].ToString("N", (IFormatProvider) nfi) + " / ";
          this.priceLabel6.Text = resourceTypeLevel.ToString("N", (IFormatProvider) nfi);
          this.setDonateRowInfo(5, requiredResourceType6);
          this.currentLevelsNeeded[5, 0] = selectedBuilding.capitalResourceLevels[5];
          this.currentLevelsNeeded[5, 1] = resourceTypeLevel;
        }
      }
      int requiredResourceType7 = VillageBuildingsData.getRequiredResourceType(selectedBuilding.buildingType, 6);
      if (requiredResourceType7 >= 0 && selectedBuilding.capitalResourceLevels.Length > 6)
      {
        int resourceTypeLevel = VillageBuildingsData.getRequiredResourceTypeLevel(selectedBuilding.buildingType, 6, rank, GameEngine.Instance.World.ThirdAgeWorld, GameEngine.Instance.World.FourthAgeWorld, GameEngine.Instance.World.FifthAgeWorld, GameEngine.Instance.World.SeventhAgeWorld, GameEngine.Instance.LocalWorldData.EraWorld);
        if (resourceTypeLevel > 0)
        {
          this.highlightLine7.Visible = true;
          this.storedLabel7.Text = selectedBuilding.capitalResourceLevels[6].ToString("N", (IFormatProvider) nfi) + " / ";
          this.priceLabel7.Text = resourceTypeLevel.ToString("N", (IFormatProvider) nfi);
          this.setDonateRowInfo(6, requiredResourceType7);
          this.currentLevelsNeeded[6, 0] = selectedBuilding.capitalResourceLevels[6];
          this.currentLevelsNeeded[6, 1] = resourceTypeLevel;
        }
      }
      int requiredResourceType8 = VillageBuildingsData.getRequiredResourceType(selectedBuilding.buildingType, 7);
      if (requiredResourceType8 < 0 || selectedBuilding.capitalResourceLevels.Length <= 7)
        return;
      int resourceTypeLevel1 = VillageBuildingsData.getRequiredResourceTypeLevel(selectedBuilding.buildingType, 7, rank, GameEngine.Instance.World.ThirdAgeWorld, GameEngine.Instance.World.FourthAgeWorld, GameEngine.Instance.World.FifthAgeWorld, GameEngine.Instance.World.SeventhAgeWorld, GameEngine.Instance.LocalWorldData.EraWorld);
      if (resourceTypeLevel1 <= 0)
        return;
      this.highlightLine8.Visible = true;
      this.storedLabel8.Text = selectedBuilding.capitalResourceLevels[7].ToString("N", (IFormatProvider) nfi) + " / ";
      this.priceLabel8.Text = resourceTypeLevel1.ToString("N", (IFormatProvider) nfi);
      this.setDonateRowInfo(7, requiredResourceType8);
      this.currentLevelsNeeded[7, 0] = selectedBuilding.capitalResourceLevels[7];
      this.currentLevelsNeeded[7, 1] = resourceTypeLevel1;
    }
    ...
    public void GetVillageInfoForDonateCapitalGoods_callback(
    ...
    {
      NumberFormatInfo nfi = GameEngine.NFI;
      VillageDonateInfo villageDonateInfo1 = (VillageDonateInfo) null;
      foreach (VillageDonateInfo villageDonateInfo2 in this.villageInfo)
      {
        if (villageDonateInfo2.villageID == villageid)
        {
          villageDonateInfo1 = villageDonateInfo2;
          break;
        }
      }
      if (villageDonateInfo1 == null)
        return;
      this.localLabel1.Text = villageDonateInfo1.resourceLevel1.ToString("N", (IFormatProvider) nfi);
      this.localLabel2.Text = villageDonateInfo1.resourceLevel2.ToString("N", (IFormatProvider) nfi);
      this.localLabel3.Text = villageDonateInfo1.resourceLevel3.ToString("N", (IFormatProvider) nfi);
      this.localLabel4.Text = villageDonateInfo1.resourceLevel4.ToString("N", (IFormatProvider) nfi);
      this.localLabel5.Text = villageDonateInfo1.resourceLevel5.ToString("N", (IFormatProvider) nfi);
      this.localLabel6.Text = villageDonateInfo1.resourceLevel6.ToString("N", (IFormatProvider) nfi);
      this.localLabel7.Text = villageDonateInfo1.resourceLevel7.ToString("N", (IFormatProvider) nfi);
      this.localLabel8.Text = villageDonateInfo1.resourceLevel8.ToString("N", (IFormatProvider) nfi);
      this.currentSelectedVillageID = villageDonateInfo1.villageID;
      this.exchangeNameLabel.Text = GameEngine.Instance.World.getVillageName(villageDonateInfo1.villageID);
      this.sendTrack.Max = 500000000;
      this.sendTrack.Value = 500000000;
    ...
    public void updateVillageHistory()
    {
      ...
      if (this.villageInfo == null)
        return;
      int line1 = 0;
      for (int index = this.villageTabOwnPage * 16; line1 < 16 && index < this.villageInfo.Count; ++line1)
      {
        if (index < this.villageInfo.Count)
        {
          VillageDonateInfo villageDonateInfo = this.villageInfo[index];
          CustomSelfDrawPanel.CSDButton villageHistory = this.getVillageHistory(line1);
          villageHistory.Visible = true;
          villageHistory.Text.Text = GameEngine.Instance.World.getVillageName(villageDonateInfo.villageID);
          villageHistory.Data = villageDonateInfo.villageID;
        }
        ++index;
      }
        ...
        foreach (VillageDonateInfo villageDonateInfo in this.villageInfo)
        {
          if (villageDonateInfo.villageID == this.currentSelectedVillageID)
          {
            if (this.sendTrack.Value >= 500000000)
            {
              ...
              {
                case 0:
                  num1 = villageDonateInfo.resourceLevel1;
                  break;
                case 1:
                  num1 = villageDonateInfo.resourceLevel2;
                  break;
                case 2:
                  num1 = villageDonateInfo.resourceLevel3;
                  break;
                case 3:
                  num1 = villageDonateInfo.resourceLevel4;
                  break;
                case 4:
                  num1 = villageDonateInfo.resourceLevel5;
                  break;
                case 5:
                  num1 = villageDonateInfo.resourceLevel6;
                  break;
                case 6:
                  num1 = villageDonateInfo.resourceLevel7;
                  break;
                case 7:
                  num1 = villageDonateInfo.resourceLevel8;
                  break;
              }
              if (num1 < 0)
                num1 = 0;
              ...
              if (autoSetLevel && this.currentSelectedRow >= 0 && this.currentSelectedRow < 8)
              {
                ...
                {
                  int num4 = num3 - num2;
                  this.sendTrack.Value = num1 < num4 ? num1 : num4;
                }
              }
            }
            ...
            this.sendNumberPackets.Text = SK.Text("DonateScreen_Packets", "Packets") + " : " + (this.sendTrack.Value / this.currentResourcePacketSize).ToString("N", (IFormatProvider) nfi);
            break;
          }
        }
        this.validateSendButtons();
    ...
    private void editSendValue()
    {
      ...
      Point screen = InterfaceMgr.Instance.ParentForm.PointToScreen(new Point(620 + this.Location.X + 217, 460 + this.Location.Y + 120 - 50));
    ...
    private void btnDonate_Click()
    {
      ...
      int selectedVillageId = this.currentSelectedVillageID;
      if (amount <= 0 || currentResource < 0 || selectedVillageId < 0)
        return;
      ...
      RemoteServices.Instance.DonateCapitalGoods(this.m_capitalVillageID, selectedVillageId, currentResource, amount, this.m_building.buildingType, this.m_building.buildingID);
    }
