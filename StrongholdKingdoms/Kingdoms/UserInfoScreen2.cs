...
namespace Kingdoms
{
  public class UserInfoScreen2 : CustomSelfDrawPanel, IDockableControl
  {
    ...
    public void init(WorldMap.CachedUserInfo userInfo)
    {
      ...
      this.standingLabelLabel.Text = userInfo == null || userInfo.standing < 0 ? "" : SK.Text("STATS_CATEGORY_TITLE_RANK", "Rank") + " : " + userInfo.standing.ToString("N", (IFormatProvider) nfi);
      ...
      if (userInfo != null)
      {
        ...
        if (userInfo.avatarData != null)
        {
          ...
          UserInfoScreen2.lastCreatedAvatar = this.avatarImage.Image = (Image) Avatar.CreateAvatar(userInfo.avatarData, ARGBColors.Transparent);
    ...
    private void addVillages(int[] villages)
    {
      ...
      intList.Sort((IComparer<int>) UserInfoScreen2.villageComparer);
      this.outgoingScrollArea.clearControls();
      int num3 = 0;
      for (int index = 0; index < intList.Count; ++index)
      {
        int villageID2 = intList[index];
        UserInfoScreen2.VillageLine control = new UserInfoScreen2.VillageLine();
        if (num3 != 0)
          num3 += 5;
      ...
      switch (num1)
      {
        ...
        case 3:
          ...
          break;
        case 4:
          str = SK.Text("ParishWallPanel_King", "King") + " - " + GameEngine.Instance.World.getCountryName(GameEngine.Instance.World.getCountryFromVillageID(villageID1));
          break;
      }
    ...
    public void addDiplomacyOverlay()
    {
      ...
      this.diplomacyHeaderImage.Position = new Point((this.Width - 400) / 2, 100);
      ...
      this.diplomacyBackgroundImage.Position = new Point((this.Width - 400) / 2, 140);
    ...
    private void InitializeComponent()
    {
      ...
      this.Name = nameof (UserInfoScreen2);
