...
// Type: Kingdoms.CountryFrontPagePanel2
...
namespace Kingdoms
{
  public class CountryFrontPagePanel2 : CustomSelfDrawPanel, IDockableControl
  {
    ...
    private void InitializeComponent()
    {
      ...
      this.Name = nameof (CountryFrontPagePanel2);
    ...
    public void init()
    {
      ...
      this.parishNameLabel.Text = SK.Text("GENERIC_Country", "Country") + " : " + GameEngine.Instance.World.getCountryName(countryFromVillageId) + " (" + GameEngine.Instance.World.getVillageName(selectedMenuVillage) + ")";
      ...
      CountryFrontPagePanel2.StoredCountryInfo country = (CountryFrontPagePanel2.StoredCountryInfo) this.countryList[countryFromVillageId];
      bool flag = false;
      ...
      if (!flag)
        this.getCountryFrontPageInfoCallback(country.lastReturnData);
    ...
    public void logout() => this.countryList.Clear();
    ...
    {
      this.sheriffLabel.Text = string.IsNullOrEmpty(this.currentLeaderName) ? "" : (!this.currentLeaderMale ? SK.Text("CountryFrontPagePanel_Current_Queen", "Current Queen") : SK.Text("CountryFrontPagePanel_Current_King", "Current King"));
