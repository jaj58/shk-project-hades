...
// Type: Kingdoms.NewAutoSelectVillagePanel
...
namespace Kingdoms
{
  public class NewAutoSelectVillagePanel : CustomSelfDrawPanel
  {
    ...
    private void InitializeComponent()
    {
      ...
      this.Name = nameof (NewAutoSelectVillagePanel);
    ...
    public void init(int tryingToJoinCounty, NewAutoSelectVillageWindow parent)
    {
      ...
      this.backgroundArea.addControl((CustomSelfDrawPanel.CSDControl) this.btnAdvanced);
