...
// Type: Kingdoms.DisbandUnitsPopup
...
namespace Kingdoms
{
  public class DisbandUnitsPopup : MyFormBase
  {
    ...
    private void InitializeComponent()
    {
      ...
      this.ClientSize = new Size(292 * InterfaceMgr.UIScale, 207 * InterfaceMgr.UIScale);
      this.Controls.Add((Control) this.customPanel);
      this.Icon = Resources.shk_icon;
      this.Name = nameof (DisbandUnitsPopup);
      this.ShowClose = true;
    ...
    public void init(int troopType)
    {
      ...
      this.customPanel.init((MyFormBase) this, troopType, false);
    }
  }
}
