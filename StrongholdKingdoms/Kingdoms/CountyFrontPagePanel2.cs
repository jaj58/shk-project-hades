...
// Type: Kingdoms.CountyFrontPagePanel2
...
namespace Kingdoms
{
  public class CountyFrontPagePanel2 : CustomSelfDrawPanel, IDockableControl
  {
    ...
    public void init()
    {
      ...
      this.parishNameLabel.Text = SK.Text("GENERIC_County", "County") + " : " + GameEngine.Instance.World.getCountyName(countyFromVillageId) + " (" + GameEngine.Instance.World.getVillageName(selectedMenuVillage) + ")";
      ...
      CountyFrontPagePanel2.StoredCountyInfo county = (CountyFrontPagePanel2.StoredCountyInfo) this.countyList[countyFromVillageId];
      bool flag = false;
      ...
      if (!flag)
        this.getCountyFrontPageInfoCallback(county.lastReturnData);
    ...
    public void logout() => this.countyList.Clear();
    ...
    private void InitializeComponent()
    {
      ...
      this.Name = nameof (CountyFrontPagePanel2);
